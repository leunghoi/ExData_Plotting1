...
hpc$Voltage <- as.numeric(gsub(",", "", hpc$Voltage))
hpc$Global_reactive_power <- as.numeric(gsub(",", "", hpc$Global_reactive_power))
...
plot(hpc$Time, hpc$Voltage, xlab = "datetime", 
     ylab="Voltage", 
     type="n")
...
plot(hpc$Time, hpc$Global_reactive_power, xlab = "datetime", 
